...
// Class Definition
//==========================================================================
// ComputeMLWallFrictionVelocityAlgorithm - utau at wall bc
//==========================================================================
//--------------------------------------------------------------------------
//-------- constructor -----------------------------------------------------
//--------------------------------------------------------------------------
ComputeMLWallFrictionVelocityAlgorithm::ComputeMLWallFrictionVelocityAlgorithm(
  Realm &realm,
  stk::mesh::Part *part,
    ...
    tolerance_(1.0e-6)
{
  ...
  if ( useShifted )
    throw std::runtime_error("machine learned tau wall is designed for elem-based with consolidated bc");

  NaluEnv::self().naluOutputP0() << "ML wall function in use" << std::endl;
}
...
//--------------------------------------------------------------------------
void
ComputeMLWallFrictionVelocityAlgorithm::execute()
{
  ...
  std::vector<double> uTanNormal(nDim);
...
//--------------------------------------------------------------------------
void
ComputeMLWallFrictionVelocityAlgorithm::zero_nodal_fields()
{
...
//--------------------------------------------------------------------------
void
ComputeMLWallFrictionVelocityAlgorithm::compute_utau(
...
//--------------------------------------------------------------------------
void
ComputeMLWallFrictionVelocityAlgorithm::normalize_nodal_fields()
{
