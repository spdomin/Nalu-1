...
#ifndef LowMachEquationSystemAlt_h
#define LowMachEquationSystemAlt_h
...
class MomentumEquationSystemAlt;
class ContinuityEquationSystemAlt;
 ...
 *  LowMachEquationSystemAlt::solve_and_update method.
 */
class LowMachEquationSystemAlt : public EquationSystem {

public:

  LowMachEquationSystemAlt (
    EquationSystems& equationSystems);
  virtual ~LowMachEquationSystemAlt();
  ...
  MomentumEquationSystemAlt *momentumEqSys_;
  ContinuityEquationSystemAlt *continuityEqSys_;
 ...
 *
 */
class MomentumEquationSystemAlt : public EquationSystem {

public:

  MomentumEquationSystemAlt(
    EquationSystems& equationSystems);
  virtual ~MomentumEquationSystemAlt();
...
class ContinuityEquationSystemAlt : public EquationSystem {

public:

  ContinuityEquationSystemAlt(
    EquationSystems& equationSystems);
  virtual ~ContinuityEquationSystemAlt();
